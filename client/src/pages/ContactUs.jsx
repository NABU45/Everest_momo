            ...
            <div className='container mx-auto px-6 lg:px-40 gap-14 flex flex-col justify-center'>
                ...
                <div className='flex md:flex-row flex-col gap-5 xl:gap-12'>
                    ...
                    <div className='custom-shadow w-full lg:w-1/3 h-[220px] lg:h-[250px]'>
                        <div className='ml-10 md:ml-6 lg:ml-8 xl:ml-16 mt-12'>
                            <div className='flex gap-2 uppercase font-semibold text-customText'>
                                <img className='w-[8%] lg:w-[10%]' src={Location} alt="" />
                                <h4 className='text-[14px] lg:text-[17px]'>Location</h4>
                            </div>
                            <p className='font-semibold text-customText w-4/5 lg:w-3/4 mt-6 italic text-xs lg:text-md'>
                    ...
                    <div className='custom-shadow w-full lg:w-1/3 h-[220px] lg:h-[250px]'>
                        <div className='ml-10 md:ml-6 lg:ml-8 xl:ml-16  mt-12'>
                            <div className='flex gap-3 uppercase font-semibold text-customText'>
                                ...
                                <h4 className='text-[14px] lg:text-[17px]'>Phone</h4>
                            </div>
                            <div className='flex gap-10 lg:gap-6 xl:gap-12'>
                                <div className='mt-6 text-customGreen font-bold text-xs lg:text-md'>
                                    <p>Phone:</p>
                                    <p className='mt-10'>Call:</p>
                                </div>
                                <div className='mt-6 flex flex-col font-semibold text-customText italic text-xs lg:text-md'>
                                    <a href='tel:+9779802428334'>(+977) 9802428334</a>
                                    <a href='tel:+9779825395895'>(+977) 9825395895</a>
                                    <a href='tel:019834637' className='mt-5 ml-10'>01-9834637</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className='custom-shadow w-full lg:w-1/3 h-[220px] lg:h-[250px]'>
                        <div className='ml-10 md:ml-6 lg:ml-8 xl:ml-16  mt-12'>
                            <div className='flex gap-3 uppercase font-semibold text-customText'>
                                ...
                                <h4 className='text-[14px] lg:text-[17px]'>Service Time</h4>
                            </div>
                            <div className='flex gap-10 lg:gap-6 xl:gap-12'>
                                <div className='flex flex-col mt-6 text-customGreen font-bold text-xs lg:text-md '>
                                    <a href='#'>MON - FRI</a>
                                    <a href='#' className='mt-2'>SAT - SUN</a>
                                </div>
                                <div className='mt-6 flex flex-col text-customText italic text-xs lg:text-md font-semibold'>
...
<div className='bg-slate-50'>
            <div className='mx-auto flex flex-col md:flex lg:flex-row  items-center mt-20 bg-slate-50 gap-10 xl:gap-24 '>
