        ...
        <nav className="bg-white shadow-md ">
                <div className="flex  justify-between items-center py-4 sm:w-screen px-5 lg:px-40">
                    ...
                    <div className="flex lg:hidden items-center">
                        <a href="/contactus" className="py-1 px-2 mr-3 text-sm md:text-md md:py-1 md:px-4 text-white bg-coustemOrange rounded-3xl">Contact Us</a>
                        <button
                ...
                <div className={`${isOpen ? 'block' : 'hidden'} lg:hidden`}>
                    <ul className="flex flex-col space-y-2 ">
                        <li>
                            <a href="/aboutus" className="block py-2 pr-4 pl-3 text-gray-700 hover:text-gray-900">About Us</a>
                        </li>
                        <li>
                            <a href="/ourmanu" className="block py-2 pr-4 pl-3 text-gray-700 hover:text-gray-900">Our Manu</a>
                        </li>
                      
                        <li>
                            <a href="/ourservice" className="block py-2 pr-4 pl-3 text-gray-700 hover:text-gray-900">Our services</a>
                        </li>
                        <li>
                            <a href="/advice" className="block py-2 pr-4 pl-3 text-gray-700 hover:text-gray-900 focus:outline-none">Allergy Advice</a>
                        </li>
