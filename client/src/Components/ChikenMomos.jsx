    ...
    <>
      ...
      <div className='mt-10 flex md:flex-row  justify-between lg:w-[936px] lg:gap-48 md:gap-36 w-100% gap-10 flex-col' >
        ...
        <div className='flex-col flex justify-center items-center mt-5'>
          <p className=' font-bold text-2xl text-customBlack font-proxima'>Chicken Steam Momo</p>
          ...
          <span className='flex justify-center text-center text-customiconbg mt-1 btnFont'>(Freshly Steamed Chicken Mommos made from whole wheat and kneaded with beat Carotene Rich Vegetable Juice)</span>
        </div>
        </div>
        <div className='flex flex-col items-center w-[350px] '>
        <div className='flex flex-col -ml-10  '>
        ...
        <div className='flex-col flex justify-center items-center mt-5'>
          <p className=' font-bold text-2xl text-customBlack font-proxima '>Chicken C. Momo</p>
          <p className='flex py-2 gap-1'><img src={vector} alt="" className='h-[17px]' />
          <span className=' text-coustemOrange text-bold text-2xl -mt-2  font-proxima'> 200</span>
          </p>
          <span className='flex justify-center text-center  btnFont text-customiconbg mt-1'>(Freshly Steamed Chicken Mommos made from whole wheat and kneaded with beat Carotene Rich Vegetable Juice)</span>
        </div>
        </div>
      </div>
      <div className='mt-10 flex md:flex-row justify-between lg:w-[936px] lg:gap-48 md:gap-36 w-100% gap-10 flex-col' >
        ...
        <div className='flex-col flex justify-center items-center mt-5'>
          <p className='font-bold text-2xl  font-proxima text-customBlack'>Chicken Fry Momo</p>
        ...
        <div className='flex-col flex justify-center items-center mt-5'>
          <p className='font-bold text-2xl text-customBlack font-proxima'>Chicken jhol Momo</p>
          <p className='flex py-2 gap-1'><img src={vector} alt="" className='h-[17px]' />
          <span className=' text-coustemOrange text-bold text-xl -mt-2 font-proxima'> 200</span>
          </p>
          <span className='flex justify-center text-center mt-1 text-customiconbg btnFont'>(Freshly Steamed Chicken Mommos made from whole wheat and kneaded with beat Carotene Rich Vegetable Juice)</span>
        </div>
        </div>
      </div>
      </div>    </>
