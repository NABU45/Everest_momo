        ...
        <div className="flex flex-col lg:flex-row justify-start lg:gap-32 gap-10">
          ...
          <div className="flex flex-col  sm:flex-row lg:gap-16 gap-10 w-full lg:w-[60%]">
            <div className="lg:w-[33%] w-full">
              <a href="#" className="text-md font-semibold text-customGreen">Momos</a>
            ...
            <div className="lg:w-[33%] w-full">
              <a href="#" className="text-md font-semibold text-customGreen">Legals</a>
              <ul className="flex flex-col justify-start mt-6 gap-2">
            ...
            <div className="lg:w-[33%] w-full">
              <a href="#" className="text-md font-semibold text-customGreen">Follow Us</a>
